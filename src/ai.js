...
const openai = new OpenAI({
  apiKey: "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", // defaults to process.env["OPENAI_API_KEY"]
});
...
export function textCompletion(context) {
  // body...
  const prompt =
